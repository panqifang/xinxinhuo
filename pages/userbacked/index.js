...
Page({
    ...
    onShow: function () {
        ...
        login().then(sid => {
            self.sid = sid
            requestGet('/orders/reward-list', { page: 1, size: 10, sid: self.sid }).then(({ success, data, msg }) => {
    ...
    onReachBottom: function () {
        ...
        if (self.canMore && self.nextPage && self.nextPage !== 0) {
            ...
            self.canMore = false
            requestGet('/orders/reward-list', { page: self.nextPage, size: 6, sid: self.sid }).then(({ success, data, msg }) => {
